        ...
        <div class="col-md-9">
            <div class="box box-default">
                <div class="box-header with-border">
                    <h3 class="box-title">Nové předplatné</h3>
                </div>
                <form:form method="post" action="/predplatne/pridat" modelAttribute="subscription">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <form:input path="days" type="number" required="required" cssClass="form-control" />
                        </div>
                    </div>
